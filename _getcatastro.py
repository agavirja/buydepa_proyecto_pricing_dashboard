...
def getcatastro(direccion):
    ...
    #data         = pd.read_pickle('https://personal-data-bucket-online.s3.us-east-2.amazonaws.com/data_catastro_completo_conjunto',compression='gzip')
    data         = pd.read_pickle('data/data_catastro_completo_conjunto',compression='gzip')
